 ...
 * 
 */
package WebDevProjectMM.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(WebDevProjectMM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
