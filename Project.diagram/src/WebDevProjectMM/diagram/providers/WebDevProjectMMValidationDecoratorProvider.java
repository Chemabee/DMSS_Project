 ...
 * @generated
 */
public class WebDevProjectMMValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && WebDevProjectMM.diagram.edit.parts.WebSiteEditPart.MODEL_ID
