 ...
 * @generated
 */
public class WebDevProjectMMMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorUtil.selectElementsInDiagram(editor,
