 ...
 * @generated
 */
public class WebDevProjectMMShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorPlugin.getInstance()
