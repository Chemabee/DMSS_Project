 ...
 * @generated
 */
public class WebDevProjectMMModelingAssistantProviderOfRegularContentPageEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart) sourceEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSource(
			WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget(
				(WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart) sourceEditPart, targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart source,
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart) targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnTarget(
			WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart target) {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart) targetEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(WebDevProjectMM.diagram.edit.parts.RegularContentPageEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == WebDevProjectMM.diagram.providers.WebDevProjectMMElementTypes.PageLink_4001) {
			types.add(WebDevProjectMM.diagram.providers.WebDevProjectMMElementTypes.CreationCRUD_2001);
