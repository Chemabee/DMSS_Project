...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(WebDevProjectMM.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		WebDevProjectMM.diagram.providers.WebDevProjectMMValidationProvider.runWithConstraints(txDomain,
				new Runnable() {
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			WebDevProjectMM.diagram.providers.WebDevProjectMMMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorUtil.findView(diagramEditPart,
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		WebDevProjectMM.diagram.providers.WebDevProjectMMMarkerNavigationProvider.addMarker(target, elementId, location,
