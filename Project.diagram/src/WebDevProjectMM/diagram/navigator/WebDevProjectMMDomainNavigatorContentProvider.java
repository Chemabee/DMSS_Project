 ...
 * @generated
 */
public class WebDevProjectMMDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public WebDevProjectMMDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof WebDevProjectMM.diagram.navigator.WebDevProjectMMDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((WebDevProjectMM.diagram.navigator.WebDevProjectMMDomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new WebDevProjectMM.diagram.navigator.WebDevProjectMMDomainNavigatorItem(
