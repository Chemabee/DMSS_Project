 ...
 * @generated
 */
public class QuestionDefinitionDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public QuestionDefinitionDescriptionEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = WebDevProjectMM.diagram.providers.WebDevProjectMMParserProvider.getParser(
					...
					getParserElement(), WebDevProjectMM.diagram.part.WebDevProjectMMVisualIDRegistry.getType(
							WebDevProjectMM.diagram.edit.parts.QuestionDefinitionDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
