...
public class WebSiteEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "WebDevProjectMM"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WebDevProjectMM.diagram.edit.policies.WebSiteItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new WebDevProjectMM.diagram.edit.policies.WebSiteCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new WebDevProjectMM.diagram.edit.commands.WebDevProjectMMCreateShortcutDecorationsCommand(
