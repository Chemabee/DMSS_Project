	...
	*/
	static {
		registerSnapBackPosition(WebDevProjectMM.diagram.part.WebDevProjectMMVisualIDRegistry
				.getType(WebDevProjectMM.diagram.edit.parts.RoleNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebDevProjectMM.diagram.providers.WebDevProjectMMParserProvider.getParser(
					WebDevProjectMM.diagram.providers.WebDevProjectMMElementTypes.Role_2008, getParserElement(),
