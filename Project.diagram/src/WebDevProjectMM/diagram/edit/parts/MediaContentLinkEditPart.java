 ...
 * @generated
 */
public class MediaContentLinkEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MediaContentLinkEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebDevProjectMM.diagram.providers.WebDevProjectMMParserProvider.getParser(
					WebDevProjectMM.diagram.providers.WebDevProjectMMElementTypes.MediaContent_3002, getParserElement(),
