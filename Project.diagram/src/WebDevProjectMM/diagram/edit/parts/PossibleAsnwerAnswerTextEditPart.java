 ...
 * @generated
 */
public class PossibleAsnwerAnswerTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PossibleAsnwerAnswerTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebDevProjectMM.diagram.providers.WebDevProjectMMParserProvider.getParser(
					...
					getParserElement(), WebDevProjectMM.diagram.part.WebDevProjectMMVisualIDRegistry
