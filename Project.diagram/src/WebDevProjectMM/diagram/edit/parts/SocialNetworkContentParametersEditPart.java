 ...
 * @generated
 */
public class SocialNetworkContentParametersEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SocialNetworkContentParametersEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new WebDevProjectMM.diagram.edit.policies.WebDevProjectMMTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return WebDevProjectMM.diagram.providers.WebDevProjectMMElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebDevProjectMM.diagram.providers.WebDevProjectMMParserProvider.getParser(
					WebDevProjectMM.diagram.providers.WebDevProjectMMElementTypes.SocialNetworkContent_3003,
					getParserElement(), WebDevProjectMM.diagram.part.WebDevProjectMMVisualIDRegistry.getType(
							WebDevProjectMM.diagram.edit.parts.SocialNetworkContentParametersEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					WebDevProjectMM.diagram.edit.parts.WebDevProjectMMEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
