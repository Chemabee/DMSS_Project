 ...
 * @generated
 */
public class DelitionCRUDEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DelitionCRUDEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new WebDevProjectMM.diagram.edit.policies.DelitionCRUDItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WebDevProjectMM.diagram.edit.parts.DelitionCRUDNameEditPart) {
			((WebDevProjectMM.diagram.edit.parts.DelitionCRUDNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureDelitionCRUDLabelFigure());
			return true;
		}
		if (childEditPart instanceof WebDevProjectMM.diagram.edit.parts.DelitionCRUDDelitionCRUDSocialnetworkcontentCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDelitionCRUDSocialnetworkcontentCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((WebDevProjectMM.diagram.edit.parts.DelitionCRUDDelitionCRUDSocialnetworkcontentCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof WebDevProjectMM.diagram.edit.parts.DelitionCRUDDelitionCRUDElementsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDelitionCRUDElementsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((WebDevProjectMM.diagram.edit.parts.DelitionCRUDDelitionCRUDElementsCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	 ...
	 * @generated
	 */
	public class DelitionCRUDFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureDelitionCRUDLabelFigure;
		/**
		 * @generated
		 */
		private RectangleFigure fDelitionCRUDSocialnetworkcontentCompartmentFigure;
		/**
		 * @generated
		 */
		private RectangleFigure fDelitionCRUDElementsCompartmentFigure;
		...
		private void createContents() {
			...
			fFigureDelitionCRUDLabelFigure = new WrappingLabel();

			fFigureDelitionCRUDLabelFigure.setText("DelitionCRUD");
			fFigureDelitionCRUDLabelFigure
					.setMaximumSize(new Dimension(getMapMode().DPtoLP(10000), getMapMode().DPtoLP(50)));

			this.add(fFigureDelitionCRUDLabelFigure);

			fDelitionCRUDSocialnetworkcontentCompartmentFigure = new RectangleFigure();
			...
			fDelitionCRUDElementsCompartmentFigure = new RectangleFigure();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDelitionCRUDLabelFigure() {
		 ...
		 * @generated
		 */
		public RectangleFigure getDelitionCRUDSocialnetworkcontentCompartmentFigure() {
		 ...
		 * @generated
		 */
		public RectangleFigure getDelitionCRUDElementsCompartmentFigure() {
