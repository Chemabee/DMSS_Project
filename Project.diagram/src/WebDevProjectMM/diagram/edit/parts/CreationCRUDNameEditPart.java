 ...
 * @generated
 */
public class CreationCRUDNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CreationCRUDNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebDevProjectMM.diagram.providers.WebDevProjectMMParserProvider.getParser(
					WebDevProjectMM.diagram.providers.WebDevProjectMMElementTypes.CreationCRUD_2001, getParserElement(),
