	...
	private static class OpenDiagramCommand extends AbstractTransactionalCommand {
		...
		*/
		OpenDiagramCommand(HintedDiagramLinkStyle linkStyle) {
			...
			super(TransactionUtil.getEditingDomain(linkStyle),
					WebDevProjectMM.diagram.part.Messages.CommandName_OpenDiagram, null);
						...
						try {
							for (Iterator it = diagramFacet.eResource().getResourceSet().getResources().iterator(); it
								...
								if (nextResource.isLoaded() && !getEditingDomain().isReadOnly(nextResource)) {
									nextResource.save(WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditorUtil
											.getSaveOptions());
								}
							}
		...
		*/
		protected String getEditorID() {
			return WebDevProjectMM.diagram.part.WebDevProjectMMDiagramEditor.ID;
		}
	}
