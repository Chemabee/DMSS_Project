...
/**
 * This is the item provider adapter for a {@link WebDevProjectMM.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNumAccesiblePagesPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebDevProjectMMPackage.Literals.ROLE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Num Accesible Pages feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumAccesiblePagesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_numAccesiblePages_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_numAccesiblePages_feature", "_UI_Role_type"),
				 WebDevProjectMMPackage.Literals.ROLE__NUM_ACCESIBLE_PAGES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addWebpagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_webpage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_webpage_feature", "_UI_Role_type"),
				 WebDevProjectMMPackage.Literals.ROLE__WEBPAGE,
				 true,
				 false,
				 true,
				 null,
