...
/**
 * This is the item provider adapter for a {@link WebDevProjectMM.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPrimary_keyPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_refersTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_refersTo_feature", "_UI_Entity_type"),
				 WebDevProjectMMPackage.Literals.ENTITY__REFERS_TO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebDevProjectMMPackage.Literals.ENTITY__ID,
				 true,
				 false,
				 false,
	 ...
	 * @generated
	 */
	protected void addPrimary_keyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_primary_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_primary_key_feature", "_UI_Entity_type"),
				 WebDevProjectMMPackage.Literals.ENTITY__PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebDevProjectMMPackage.Literals.ENTITY__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebDevProjectMMPackage.Literals.ENTITY__ATTRIBUTES,
				 WebDevProjectMMFactory.eINSTANCE.createAttribute()));
	}
