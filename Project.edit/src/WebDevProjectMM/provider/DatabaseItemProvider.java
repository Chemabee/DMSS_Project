...
/**
 * This is the item provider adapter for a {@link WebDevProjectMM.Database} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatabaseItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebDevProjectMMPackage.Literals.DATABASE__ENTITIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Database.class)) {
			case WebDevProjectMMPackage.DATABASE__ENTITIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebDevProjectMMPackage.Literals.DATABASE__ENTITIES,
				 WebDevProjectMMFactory.eINSTANCE.createEntity()));
	}
